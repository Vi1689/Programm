...
int main()
{
    struct rbtree* a = rbtree_create(3, "puck");
    rbtree_add(root(a), 1, "puck");
    rbtree_add(root(a), 2, "puck");
    // rbtree_add(root(a), 4, "puck");
    // rbtree_add(root(a), 5, "puck");
    // rbtree_add(root(a), 7, "puck");
    rbtree_print_dfs(root(a), 1);
    struct rbtree* b = root(a);
    rbtree_delete(b, 1);
    printf("\n");
    b = root(a);
    rbtree_print_dfs(b, 1);
    printf("\n");
    rbtree_free(root(a));
}