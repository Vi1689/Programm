...
plot x title "Linear speedup" with lines lc rgb 'blue' lt 1 lw 2,\
     'test_1.txt' using 1:2 title "N=15000" with linespoints ls 2,\
     'test_2.txt' using 1:2 title "N=20000" with linespoints ls 3,\
     'test_3.txt' using 1:2 title "N=25000" with linespoints ls 4
