...
plot x title "Linear speedup" with lines lc rgb 'blue' lt 1 lw 2,\
     'lab_2/test_1.txt' using 1:2 title "N=15000 var 1" with linespoints ls 2,\
     'lab_2/test_2.txt' using 1:2 title "N=20000 var 1" with linespoints ls 3,\
     'lab_2/test_3.txt' using 1:2 title "N=25000 var 1" with linespoints ls 4
