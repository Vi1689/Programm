...
plot x title "Linear speedup" with lines lc rgb 'blue' lt 1 lw 2,\
     'lab_3/test_1.txt' using 1:2 title "Метод прям" with linespoints ls 2,\
     'lab_3/test_2.txt' using 1:2 title "Метод Монте-Карло" with linespoints ls 3
