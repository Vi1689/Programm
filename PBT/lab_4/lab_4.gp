...
plot x title "Linear speedup" with lines lc rgb 'blue' lt 1 lw 2,\
     'test_1.txt' using 1:2 title "1" with linespoints ls 2,\
     'test_2.txt' using 1:2 title "2" with linespoints ls 3,\
     'test_3.txt' using 1:2 title "3" with linespoints ls 4,\
     'test_4.txt' using 1:2 title "4" with linespoints ls 5,\
     'test_5.txt' using 1:2 title "5" with linespoints ls 6